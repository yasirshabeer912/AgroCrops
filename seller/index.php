									...
									<div class="card-body">
										<div class="media align-items-center">
											<div class="media-body me-3">
												<?php
												$id=$_SESSION['user_id'];
                                               $sql_ads=$con->query("select * from ads where seller_id='$id' ");
								...
								<div class="card fun">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<?php
												$id=$_SESSION['user_id'];
                                               $sql_aprove=$con->query("select * from ads where status='aprove' AND seller_id='$id'");
									...
									<div class="card-body">
										<div class="media align-items-center">
											<div class="media-body me-3">
												<?php
													$id=$_SESSION['user_id'];
											$sql_reject=$con->query("select * from ads where status='reject' AND seller_id='$id'");
								...
								<div class="card fun">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<?php
												$id=$_SESSION['user_id'];
											$sql_pending=$con->query("select * from ads where status='pending' AND seller_id='$id'");
