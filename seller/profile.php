...
if(isset($_POST['update_profile'])){
	...
	if($image==""){
		$sql=$con->query("update users set fname='$fname',lname='$lname',email='$email',phone='$phone',city='$city' where id='$id'");
		if($sql){
	...
	else
	{
		...
		$sql=$con->query("update users set fname='$fname',lname='$lname',email='$email',phone='$phone',city='$city',image='$image' where id='$id'");
		if($sql){
			$_SESSION['success']="Profile Update Successfully";
			// header("location:profile.php");
		}
								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col-sm-6 m-b30">
											...
											<input type="text" name="fname" class="form-control" value="<?php  echo $sql['fname']?>">
										</div>
										<div class="col-sm-6 m-b30">
											<label class="form-label">Last Name</label>
											<input type="text" name="lname" value="<?php echo $sql['lname'] ?>" class="form-control">
										</div>
										<div class="col-sm-6 m-b30">
