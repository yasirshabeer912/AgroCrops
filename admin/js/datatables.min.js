 ...
 *   https://datatables.net/download/#bs5/jq-3.6.0/dt-1.13.1/af-2.5.1/b-2.3.3/cr-1.6.1/date-1.2.0/fc-4.2.1/fh-3.3.1/kt-2.8.0/r-2.4.0/rg-1.3.0/rr-1.3.1/sc-2.0.7/sb-1.4.0/sp-2.1.0/sl-1.5.0/sr-1.2.0
 *
 * Included libraries:
 *   jQuery 3 3.6.0, DataTables 1.13.1, AutoFill 2.5.1, Buttons 2.3.3, ColReorder 1.6.1, DateTime 1.2.0, FixedColumns 4.2.1, FixedHeader 3.3.1, KeyTable 2.8.0, Responsive 2.4.0, RowGroup 1.3.0, RowReorder 1.3.1, Scroller 2.0.7, SearchBuilder 1.4.0, SearchPanes 2.1.0, Select 1.5.0, StateRestore 1.2.0
 */
