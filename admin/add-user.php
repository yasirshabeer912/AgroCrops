                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" required name="fname" class="form-control border border-2" placeholder="first name">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Last Name</label>
                                                <input type="text" required name="lname" class="form-control border border-2" placeholder="last name">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Email</label>
                                                <input type="text" required name="email" class="form-control border border-2" placeholder="email">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Password</label>
                                                <input type="password" required name="password" class="form-control border border-2" placeholder="Password">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>confirm Password</label>
                                                <input type="password" required name="confirm_password" class="form-control border border-2" placeholder="confirm password">
                                            </div>
