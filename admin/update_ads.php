...
if(isset($_POST['ads_update'])){
    ...
    $date=date("D-m-Y");
    if($image==""){
        $sql=$con->query("update ads set seller_id='$seller_id',name='$name',contact_no='$contact_no',city='$city',
        location='$location',title='$title',description='$description',price='$price',category_id='$category_id',date='$date' where id='$id'");
        if($sql){
            $_SESSION['success']="Ads Update Successfully";
    ...
    $sql=$con->query("update ads set seller_id='$seller_id',name='$name',contact_no='$contact_no',city='$city',
    location='$location',title='$title',description='$description',image='$image',price='$price',category_id='$category_id',date='$date' where id='$id'");
    if($sql){
        $_SESSION['success']="Ads Update Successfully";
        header("location:view-ads.php");
    }
                                    ...
                                    <input type="hidden" name="id" value="<?php echo $sql['id'] ?>">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Name</label>
                                                <input type="text" required name="name" value="<?php echo $sql['name'] ?>" class="form-control" placeholder="Name">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Contact No</label>
                                                <input type="text"required name="contact_no"  value="<?php echo $sql['contact_no'] ?>" class="form-control" placeholder="Contact number">
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label>City</label>
                                                <input type="text"required name="city"  value="<?php echo $sql['city'] ?>" class="form-control" placeholder="City">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>location</label>
                                                <input type="text"required name="location"  value="<?php echo $sql['location'] ?>" class="form-control" placeholder="location">
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Title</label>
                                                <input type="text" required name="title"  value="<?php echo $sql['title'] ?>" class="form-control border border-2" placeholder="Title">
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label>Price</label>
                                                <input type="text" required name="price"  value="<?php echo $sql['price'] ?>" class="form-control" placeholder="Price">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Discription</label>
                                               <textarea name="description" class="form-control" id="" cols="50" rows="5"> <?php echo $sql['description'] ?></textarea>
                                            </div>
                                        </div>
                                      


                                        <button type="submit" name="ads_update" class="btn btn-primary">Update</button>
                                    </form>
                                </div>
                            </div>
                        </div>
