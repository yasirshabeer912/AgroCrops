...
if(isset($_POST['ads_upload'])){
    ...
    location='$location',title='$title',description='$description',image='$image',price='$price',category_id='$category_id',date='$date'");
    if($sql){
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text"required name="contact_no" class="form-control" placeholder="Contact number">
                                            </div>
