...
if(isset($_GET['id'])){
    ...
    $sql=$con->query("update ads set status='$status' where id='$id'");
    if($sql){
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Ads View Table</h4>
                                <?php
                                    ...
                                    <table id="myTable" class="table table-responsive-md">
                                        ...
                                        <tbody>
                                            ...
                                            while($row=$sql->fetch_assoc()){
                                              ...
                                              $get_c=$con->query("select * from category where id='$id_c'")->fetch_assoc();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if($row['status']=='pending'){
                                                        echo '  <span class="badge light badge-info">Pending</span>';
                                                    } 
                                                    else if($row['status']=='aprove'){
                                                        echo '  <span class="badge light badge-success">Aprove</span>';
                                                    }
                                                    else if($row['status']=='reject'){
                                                        echo '  <span class="badge light badge-danger">Reject</span>';
                                                    }
                                                    ?>
                                                ...
                                                <td>
                                                <?php if($row['status']== 'pending' || $row['status']=='reject'){?>
                                                    <a href="?id=<?php echo $row['id'] ?>&&status=reject" class="btn btn-danger">Reject</a>
                                                    <a  class="btn btn-success" href="?id=<?php echo $row['id'] ?>&&status=aprove">Aprove</a>
													<?php }?>
                                                 <?php if($row['status']== 'aprove'){?>
                                                    <a class="btn btn-primary" href="update_ads.php?id=<?php echo $row['id'] ?>">Edit</a>
                                                    <a class="btn btn-info" href="ads_full_detail.php?id=<?php echo $row['id'] ?>">View</a>
