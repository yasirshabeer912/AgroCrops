...
if (isset($_POST['update_category'])) {
    ...
    if ($image == "") {
        ...
        $sql = $con->query("update  category set name='$name',date='$date' where id='$id'");
        if ($sql) {
            $_SESSION['success'] = "category Successfully";
    ...
    $sql = $con->query("update  category set name='$name',date='$date',image='$image' where id='$id'");
    if ($sql) {
        $_SESSION['success'] = "category Successfully";
        header("location:view_category.php");
    } else {
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        <input type="hidden" value="<?php echo $sql['id'] ?>" name="id">
                                      
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Name</label>
                                                <input type="text" required value="<?php echo $sql['name'] ?>" name="name" class="form-control border border-2" placeholder="Name">
                                            </div>
