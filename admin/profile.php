...
if(isset($_POST['update_profile'])){
	...
	if($image==""){
		$sql=$con->query("update admin set name='$name',email='$email',phone='$phone' where id='$id'");
		if($sql){
	...
	else
	{
		...
		$sql=$con->query("update admin set name='$name',email='$email',phone='$phone',image='$image' where id='$id'");
		if($sql){
			$_SESSION['success']="Profile Update Successfully";
			echo " <script>
			function autoRefresh() {
					...
					<div class="col-xl-12 col-lg-12">
						<div class="card  card-bx m-b30">
							...
							<?php
							  ...
							  $sql=$con->query("select * from admin where id='$id'")->fetch_assoc();
							?>
								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col-sm-6 m-b30">
											...
											<input type="text" name="name" class="form-control" value="<?php  echo $sql['name']?>">
										</div>
