...
if(isset($_POST['add_category'])){
    ...
    $sql=$con->query("insert into  category set name='$name',date='$date',image='$image'");
    if($sql){
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Name</label>
                                                <input type="text" required name="name" class="form-control border border-2" placeholder="Name">
                                            </div>
                                        ...
                                        <button type="submit" name="add_category" class="btn btn-primary">Upload</button>
                                    </form>
                                </div>
                            </div>
                        </div>
